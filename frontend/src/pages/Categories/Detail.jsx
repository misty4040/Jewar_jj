...
export default function CategoryDetail() {
    ...
    if (loading || !cat) {
        return (
            <div className="maison" style={{ minHeight: '100vh', background: 'var(--ivory)' }} />
        );
    }
            ...
            <div>
                <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-3">
                        <span className="mono" style={{ color: 'var(--ink)', fontSize: 11, letterSpacing: '0.4em' }}>
                            Filters
                        </span>
                        <span
                            className="mono"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
                        ...
                        <div className="lg:col-span-9">
                            {products.length === 0 ? (
                                ...
                                >
                                    {firstBatch.map((p, i) => (
                                        <MaisonProductCard key={p._id || i} product={p} index={i} categorySlug={slug} />
                                    ))}
                            ...
                            {related.map((c) => (
                                ...
                                >
                                    <img
                                        ...
                                        style={{
                                            objectPosition: c.heroPosition || '50% 50%',
                    ...
                    >
                        <span className="flex items-center gap-3">
                            ...
                            <span
                                ...
                                style={{ fontSize: 15, letterSpacing: '0.005em', color: 'inherit' }}
                            >
                                {opt.name}
                            </span>
                        </span>
